...
const caixa Perguntas const caixaAlternativas document.querySelector(".caixa-perguntas"); document.querySelector(".caixa-alternativas");
...
function resposta Selecionada (opcaoSelecionada) { const afirmacao opcaoSelecionada.afirmacao; historiaFinal + afirmacao atual++
